...
stories.addWithInfo('Icon with circle style', function () {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_icon2.default, { size: '14px' })
    ),
    '\xA0',
    _react2.default.createElement(
      _index2.default,
    ...
    _react2.default.createElement(
      _index2.default,
      { size: 'mini', circle: true },
      _react2.default.createElement(_icon2.default, { size: '36px' })
    ),
    '\xA0',
    _react2.default.createElement(
      _index2.default,
      { size: 'mini', circle: true },
      _react2.default.createElement(_icon2.default, { size: '50px' })
    ),
    _react2.default.createElement('br', null),
    _react2.default.createElement('br', null),
    _react2.default.createElement(
