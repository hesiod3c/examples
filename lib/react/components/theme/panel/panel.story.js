...
var stories = (0, _storybook.storiesOf)('Panel', module);
...
stories.addWithInfo('basic', function () {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      ' dolor sit amet, consectetuer. Aliquam ornare wisi eu metus. Integer pellentesque quam vel velit. Duis pulvinar.'
    ),
    _react2.default.createElement(
      'p',
      null,
      ...
      '. Morbi imperdiet, mauris ac auctor dictum, sem purus in lacus.'
    )
  );
});
...
stories.addWithInfo('scroll', function () {
  return _react2.default.createElement(
    _index2.default,
    { scroll: true, header: 'T\xEDtulo', footer: 'footer', footerAddon: 'footerAddon' },
    _react2.default.createElement(
      'p',
      null,
...
stories.addWithInfo('header', function () {
  return _react2.default.createElement(_index2.default, { scroll: true, header: 'T\xEDtulo' });
});