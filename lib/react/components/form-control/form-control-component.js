...
// style
var styles = {
  'form-field': 'form-control_form-field_2Z7zy',
  'form-field--select': 'form-control_form-field--select_21EM4',
  'form-field--textarea': 'form-control_form-field--textarea_2rgKI',
  'form-field--radio': 'form-control_form-field--radio_30uzz',
  'form-field--checkbox': 'form-control_form-field--checkbox_3KgS9',
  'form-addon-before': 'form-control_form-addon-before_1yVKR',
  'form-addon-after': 'form-control_form-addon-after_3_M3E',
  'form-addon': 'form-control_form-addon_C02iw',
  'form-addon--withItens': 'form-control_form-addon--withItens_ViqNQ',
  'form-feedback': 'form-control_form-feedback_3oLaX'
};
  ...
  _createClass(FormControl, [{
    ...
    value: function _generateComponent(controlId, type) {
      ...
      var _props = this.props,
          ...
          name = _props.name,
          elementProps = _objectWithoutProperties(_props, ['addonBefore', 'addonAfter', 'feedback', 'getRef', 'onChange', 'onFocus', 'onBlur', 'disabled', 'children', 'name']);
    ...
    value: function _getFeedback(state) {
      ...
      switch (state) {
        case 'success':
          result = _react2.default.createElement(_svgIcon2.default, { name: 'check' });
          break;
        case 'warning':
          result = _react2.default.createElement(_svgIcon2.default, { name: 'warning' });
          break;
        case 'error':
          result = _react2.default.createElement(_svgIcon2.default, { name: 'close' });
          break;
      }
...
FormControl.propTypes = {
  ...
  feedback: _react.PropTypes.bool,
  type: _react.PropTypes.oneOf(['text', 'password', 'select', 'textarea', 'radio', 'checkbox', 'file', 'hidden', 'search', 'email', 'range', 'number', 'month', 'tel', 'time', 'url', 'week', 'date', 'datetime', 'color'])
};
FormControl.contextTypes = {
  $formGroup: _react.PropTypes.object
};
