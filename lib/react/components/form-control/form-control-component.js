...
var FormControl = function (_PureComponent) {
  ...
  _createClass(FormControl, [{
    ...
    value: function _getFeedback(state) {
      ...
      switch (state) {
        case 'success':
          result = _react2.default.createElement(_svg2.default, { name: 'icon/check' });
          break;
        case 'warning':
          result = _react2.default.createElement(_svg2.default, { name: 'icon/warning' });
          break;
        case 'error':
          result = _react2.default.createElement(_svg2.default, { name: 'icon/close' });
          break;
      }
