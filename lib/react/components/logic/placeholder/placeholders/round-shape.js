...
var RoundShape = function (_PureComponent) {
  _inherits(RoundShape, _PureComponent);
  ...
  _createClass(RoundShape, [{
    ...
    value: function render() {
      ...
      var classes = [styles.round, className].filter(function (c) {
        return c;
      }).join(' ');
...
exports.default = (0, _reactCssModules2.default)(RoundShape, styles);