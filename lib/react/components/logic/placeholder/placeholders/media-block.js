...
var MediaBlock = function (_PureComponent) {
  ...
  _createClass(MediaBlock, [{
    ...
    value: function render() {
      ...
      var classes = [styles.media, className].filter(function (c) {
        return c;
      }).join(' ');
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_textBlock2.default, { rows: rows })
      );
    }
    /**
     * propTypes
...
exports.default = (0, _reactCssModules2.default)(MediaBlock, styles);