...
stories.addWithInfo('basic', () => (
  <Panel header="Título">
    <p><strong>Lorem ipsum</strong> dolor sit amet, consectetuer. Aliquam ornare wisi eu metus. Integer pellentesque quam vel velit. Duis pulvinar.</p>
    <p> Maecenas ipsum velit, <i>consectetuer eu</i>. Morbi imperdiet, mauris ac auctor dictum, sem purus in lacus.</p>
  </Panel>
));

stories.addWithInfo('scroll', () => (
  <Panel scroll header="Título" footer="footer" footerAddon="footerAddon">
...
stories.addWithInfo('header', () => (
  <Panel scroll header="Título" />
));
